        ...
        <div class="card-container">
            <div class="container">
                ...
                <div class="padded-box row">
                    ...
                    <div class="col-md-4">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <p class="card-text">Nam lacinia aliquet tempus. Sed vitae semper augue. Vestibulum pulvinar laoreet egestas. Nam justo ante, aliquet sed ligula in, tempus malesuada. </p>
                                <a href="#" class="btn btn-primary">Left link</a>
                                <a href="#" class="btn btn-secondary">Right link</a>
                            </div>
                        </div>
                ...
                <div class="padded-box row">
                    ...
                    <div class="col-md-4">
                        <div class="card text-center">
                            <img class="card-img-top" src="images/meme5.jpg" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card text-center">
                            <img class="card-img-top" src="images/meme6.jpg" alt="Card image cap">
                            <div class="card-body">
