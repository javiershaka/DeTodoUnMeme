...
<html lang="en">
    ...
    <body id="home" data-spy="scroll" data-target="#navbar-top" data-offset="200">
        ...
        <!-- Main navigation -->
        <nav id="navbar-top" class="navbar fixed-top navbar-expand-md navbar-dark bg-primary">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNavbar">
                    <ul class="navbar-nav mr-auto justify-content-end">
                        ...
                        <li data-toggle="collapse" data-target=".navbar-collapse.show" class="nav-item">
                                <a class="nav-link" href="#style-examples">Styles</a>
                        </li>

                        <li data-toggle="collapse" data-target=".navbar-collapse.show" class="nav-item">
                                <a class="nav-link" href="#three-column">Three Column</a>
                        </li>

                        <li data-toggle="collapse" data-target=".navbar-collapse.show" class="nav-item">
                                <a class="nav-link" href="#one-column">One Column</a>
                        </li>
                        <li data-toggle="collapse" data-target=".navbar-collapse.show" class="nav-item">
                                <a class="nav-link" href="#contact">Contact</a>
                        </li>
                        <li data-toggle="collapse" data-target=".navbar-collapse.show" class="nav-item">
                                <a class="nav-link" href="index.html">Multi-Page Layout</a>
                        </li>
                    </ul>
                </div>              
            </div>
        ...
        <div id="style-examples" class="jumbotron-wrap">
            <div class="container">
                <div class="jumbotron">
                ...
                <div class="padded-box pt-0 row">
                    ...
                    <div class="col-md-4">
                        <div class="card text-center">
                          ...
                          <div class="card-body">
                            <blockquote class="card-text">Quisque faucibus neque sodales, suscipit nisi vitae, placerat nisi. Nam cursus molestie posuere. Integer et est id nisi.</blockquote>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <article>
                            ...
                            <p>Welcome to goodness, a free CSS3 &amp; HTML5 responsive web template from <a href="https://zypopwebtemplates.com/" title="ZyPOP">ZyPOP</a>. This template is completely <strong>free</strong> to use permitting a link remains back to  <a href="https://zypopwebtemplates.com/" title="ZyPOP">http://zypopwebtemplates.com/</a>.</p>
...
USA
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3021.9856568207324!2d-73.9852353!3d40.7623402!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c2585631334765%3A0x5dbf06b70e5364d8!2sGershwin+Theatre!5e0!3m2!1sen!2suk!4v1517586622554" height="300" style="width:100%;border:0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="footer">
            ...
            <div class="footer-bottom">
                    <p class="text-center">Free Website Template by <a href="https://zypopwebtemplates.com/">ZyPop</a>.</p>
